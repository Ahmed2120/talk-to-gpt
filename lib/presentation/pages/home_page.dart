...
class _HomePageState extends State<HomePage> {
          ...
          children: [
            Consumer<ChatProvider>(builder: (context, chatProvider, _) {
              return Container(
                ...
                child: ListTile(
                  onTap: () async {
                    final chat =
                        await chatProvider.storeChat(chat: Chat(name: ''));
            ...
            Consumer<ChatProvider>(builder: (context, chatProvider, _) {
              return SizedBox(
                ...
                child: chatProvider.allchatsLoading
                    ? const Center(
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) => Container(
                          ...
                          child: ListTile(
                            onTap: () {
                              chatProvider
                                  .getMessages(chatProvider.chats[index].id!);
                              GlobalMethods.navigate(context,
                                  ChatPage(chat: chatProvider.chats[index]));
                            },
                            title: Text(
            ...
            children: [
              ...
              ListTile(
                ...
                trailing: Container(
                  ...
                  child: const Text(
                    'NEW',
                    style: TextStyle(color: Color(0xFF887B06)),
                  ),
                ),
              ),
              ...
              const ListTile(
                title: Text(
                  'Logout',
                  style: TextStyle(color: Color(0xFFED8C8C)),
                ),
                leading: Icon(
                  Icons.logout,
  ...
  void send() async {
    ...
    final res = await openAI.onCompletion(
        request: CompleteText(
            prompt: text, model: TextBabbage001Model(), maxTokens: 100));
    print(res);
